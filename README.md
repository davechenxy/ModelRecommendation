...
\begin{equation}
\operatorname{Trf}(M \rightarrow D) = E_{D_t}\left[\operatorname{acc}\left(y_t, x_t ; \theta, h_t\right)\right]
\end{equation}
...
![Transferability Matrix](path/to/transferability_matrix.jpg)
